...
public class SavingAccount extends Account {
	...
	public SavingAccount(String accountNo, String accountName, String accountAddress, double interestRate, String branchName, AccountType accountType) {
	...
	private String initiateAccountCreation(CustomerInfo customerInfo,
		...
		Account savingAcc = new SavingAccount(accountNo, customerInfo.getName(), customerInfo.getAddress(), 7.0, "WALMI", AccountType.Saving);
...
/*		savingAcc.setAccountNo(accountNo);
	...
	void getAllAccountDetails(List<CustomerAccount> accountList) {
		...
		for (CustomerAccount customerAccount : accountList) {
			if(customerAccount.getAccount().getAccountType().equals(AccountType.Saving))
