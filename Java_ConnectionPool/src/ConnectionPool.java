...
// http://www.java2s.com/Code/Java/Database-SQL-JDBC/Yourownconnectionpool.htm
...
public class ConnectionPool {
	...
	+--------------------------------------------------*/
	  ...
	  protected boolean _draining = false; // What the fuck is that?

	  protected PoolCleaner _cleaner; // What does it clean and why do we need it?
	 ...
	 * 
	 */
	private PoolConnection getExistingConnection() {
