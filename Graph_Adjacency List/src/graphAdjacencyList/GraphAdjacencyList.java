...
public class GraphAdjacencyList {
	...
	public static void main(String[] args) {
		...
		try {
			/* Read the no of vertices and edges in graph. */
			...
			System.out.println("enter the edges in graph format : <source> <destination>");
			...
			System.out.println("Adjacency list of the graph is as follows..");
